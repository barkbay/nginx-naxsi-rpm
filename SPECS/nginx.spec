...
Source12: https://github.com/nbs-system/naxsi/archive/0.54.tar.gz
Source13: naxsi.rules
...
%build
./configure \
        --add-module=${RPM_BUILD_DIR}/naxsi-0.54/naxsi_src \
...
%{__install} -m 644 -p %{SOURCE13} \
   $RPM_BUILD_ROOT%{_sysconfdir}/nginx/naxsi.rules
...
%config(noreplace) %{_sysconfdir}/nginx/naxsi.rules
...
Thanks for using nginx with NAXSI flavor !
